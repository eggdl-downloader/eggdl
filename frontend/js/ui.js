        ...
        <tr id="row-${item.id}">
          ...
          <td class="col-actions">
            <div class="action-buttons">
              ${isDownloading ? `
                <button class="action-icon-btn" onclick="App.pauseTask('${item.id}')" title="Pause Download">
                  <i data-lucide="pause"></i>
                </button>
                <button class="action-icon-btn action-delete" onclick="App.cancelTask('${item.id}')" title="Cancel Download">
                  <i data-lucide="x"></i>
                </button>
              ` : (isPaused ? `
                <button class="action-icon-btn action-play" onclick="App.resumeTask('${item.id}')" title="Resume Download">
